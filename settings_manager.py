...
def get_auras():
    ...
    try:
        ...
        dl = requests.get("https://raw.githubusercontent.com/bazthedev/SolsRNGBot/main/auras_new.json", timeout=10)
        dl.raise_for_status() 
...
def get_biomes():
    ...
    try:
        dl = requests.get("https://raw.githubusercontent.com/bazthedev/SolsRNGBot/main/biomes.json", timeout=10)
        dl.raise_for_status()
