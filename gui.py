...
from PyQt6.QtCore import Qt, pyqtSignal, QObject, QMetaObject, Q_ARG, pyqtSlot, QPropertyAnimation, QEasingCurve
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle(f"SolsScope v{LOCALVERSION}")
    ...
    def add_actions_tab_extras(self, layout):
        ...
        # Add Tesseract status for merchant detection
        layout.addSpacing(20)
        tesseract_label = QLabel("Merchant Detection Requirements")
        tesseract_label.setStyleSheet("font-weight: bold; font-size: 12px;")
    ...
    def add_biomes_tab_extras(self, layout):
        """Adds biome configuration buttons to the Biomes tab layout."""
        ...
        # Biome Notification Settings Button
        ...
        # Glitched Items Settings Button  
        ...
        # Dreamspace Items Settings Button
    ...
    def create_credits_tab(self):
        ...
        for dev_name, dev_info in [
            ...
            dev_cards_layout.addWidget(dev_card)

        # Add stretch to center the cards
        dev_cards_layout.addStretch()
    ...
    def _get_thread_targets(self, is_autocraft_mode, is_idle_mode):
        ...
        if is_idle_mode:
            ...
            targets = {
                ...
                "Obby": (do_obby, [self.settings, self.webhook, self.stop_event, self.sniped_event, self.keyboard_lock, self.mkey, self.keyboard_controller, self.ignore_lock, self.ignore_next_detection]) if self.settings.get("do_obby") and not self.settings.get("do_not_walk_to_stella", False) else None,
