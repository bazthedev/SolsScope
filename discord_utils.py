...
class Sniper:
    ...
    async def setup(self):
        ...
        self.roblox_session.headers["User-Agent"] = f"SolsRNGBot/{LOCALVERSION} Sniper (github.com/bazthedev/SolsRNGBot)"
    ...
    async def get_guild_id(self) -> typing.Optional[str]:
        ...
        headers = {
            "Authorization": discord_token,
             "User-Agent": f"SolsRNGBot/{LOCALVERSION} (github.com/bazthedev/SolsRNGBot, Guild ID Fetcher)"
        }
    ...
    async def _send_notification(self, choice_id: int, server_code: str, msg_content: str):
        ...
        embed.set_footer(text=f"SolsRNGBot v{LOCALVERSION} Sniper")
